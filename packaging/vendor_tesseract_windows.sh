...
curl -sL -o "$WORK_DIR/setup.exe" "$TESSERACT_INSTALLER_URL"
...
curl -sL -o "$OUT_DIR/tessdata/eng.traineddata" \
  "https://raw.githubusercontent.com/tesseract-ocr/tessdata_fast/$TESSDATA_FAST_COMMIT/eng.traineddata"
curl -sL -o "$OUT_DIR/tessdata/osd.traineddata" \
  "https://raw.githubusercontent.com/tesseract-ocr/tessdata_fast/$TESSDATA_FAST_COMMIT/osd.traineddata"
